	...
	hexToRgb = function (t) {
		(t = 0 === t.indexOf("#") ? t.substring(1) : t),
			(t = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(
				t.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, function (t, e, r, o) {
					return e + e + r + r + o + o;
				})
			));
		return t
...
var breakpoints = { xs: 0, sm: 576, md: 768, lg: 992, xl: 1200, xxl: 1540 },
	...
	getPastDates = function (t) {
		...
		var r = new Date(),
			o = r,
			r = new Date(new Date().setDate(r.getDate() - (e - 1)));
		return getDates(r, o);
	},
	...
	echartSetOption = function (e, r, o) {
		var t = document.body;
		e.setOption(window._.merge(o(), r)),
	...
	echartsBarLineChartInit = function () {
		var t,
			e,
			r = document.querySelector(".echart-bar-line-chart-example");
		r &&
	...
	echartsBarRaceChartInit = function () {
		...
		a &&
			...
			(r = Array.from(Array(7).keys()).map(function () {
	...
	echartsBarStackedChartInit = function () {
		...
		if (t) {
			for (
				...
				r.push("Class".concat(s + 1)),
					o.push((2 * Math.random()).toFixed(2)),
			...
			echartSetOption(t, e, function () {
				return {
					...
					series: [
						{ name: "Bar1", type: "bar", stack: "one", emphasis: n, data: o },
	...
	echartsWaterFallChartInit = function () {
		var t,
			e,
			r = document.querySelector(".echart-nightfall-chart-example");
		r &&
			((t = utils.getData(r, "options")),
			(r = window.echarts.init(r)),
			(e = [
	...
	echartsBasicCandlestickChartInit = function () {
		var t,
			e,
			r = document.querySelector(".echart-candlestick-chart-example");
		r &&
			((t = utils.getData(r, "options")),
			(r = window.echarts.init(r)),
			(e = [
	...
	echartsBubbleChartInit = function () {
		var t,
			e,
			r = document.querySelector(".echart-bubble-chart-example");
		r &&
			((t = utils.getData(r, "options")),
			(r = window.echarts.init(r)),
			(e = [
	...
	echartsCandlestickMixedChartInit = function () {
		...
		i &&
			...
			(r = utils.getPastDates(61).map(function (t) {
				return window.dayjs(t).format("MMM DD, YYYY");
			})),
			(a = (function (t, e) {
				for (var r = [], o = 0, a = e.length; o < a; o += 1)
					if (o < t) r.push("-");
					else {
						for (var i = 0, l = 0; l < t; l += 1) i += e[o - l][1];
						r.push((i / t).toFixed(2));
					}
				return r;
			})(
				5,
	...
	echartsDoughnutRoundedChartInit = function () {
		var t,
			e,
			r = document.querySelector(".echart-doughnut-rounded-chart");
		r &&
			((t = utils.getData(r, "options")),
	...
	echartsDynamicLineChartInit = function () {
		...
		if (t) {
			...
			echartSetOption(r, e, function () {
				...
				setInterval(function () {
					for (var t = 0; t < 5; t++) a.shift(), a.push(o());
					r.setOption({ series: [{ data: a }] });
				}, 1e3);
		}
	},
	...
	echartsGaugeMultiRingChartInit = function () {
		var t,
			e = document.querySelector(".echart-gauge-multi-ring-chart-example");
		e &&
			((t = utils.getData(e, "options")),
			(e = window.echarts.init(e)),
			echartSetOption(e, t, function () {
	...
	echartsGaugeMultiTitleChartInit = function () {
		var t,
			e,
			r = document.querySelector(".echart-gauge-multi-title-chart-example");
		r &&
			((t = utils.getData(r, "options")),
			(r = window.echarts.init(r)),
			(e = function (t) {
	...
	echartsGaugeRingChartInit = function () {
		var t,
			e,
			r = document.querySelector(".echart-gauge-ring-chart-example");
		r &&
			((t = utils.getData(r, "options")),
			(r = window.echarts.init(r)),
			(e = function (t) {
	...
	echartsGradientBarChartInit = function () {
		var t,
			...
			o,
			a,
			i = document.querySelector(".echart-gradient-bar-chart-example");
		i &&
			((t = utils.getData(i, "options")),
			(e = window.echarts.init(i)),
			(r = function (t) {
				return '<div> \n          <h6 class="fs--1 text-700 mb-0">\n          <span class="dot me-1 fs--2  bg-primary" ></span> '
					.concat(t[0].name, " : ")
					.concat(t[0].value, " \n           </h6>\n        </div> ");
			}),
			(o = [
			...
			e.on("click", function (t) {
				e.dispatchAction({
					...
					endValue: o[Math.min(t.dataIndex + 3, a.length - 1)],
				});
			}));
	},
	...
	echartsHorizontalBarChartInit = function () {
		var t,
			e,
			r,
			o = document.querySelector(".echart-horizontal-bar-chart-example");
		o &&
			((t = utils.getData(o, "options")),
			(o = window.echarts.init(o)),
			(e = [
	...
	echartsLineMarkerChartInit = function () {
		var t,
			e,
			r = document.querySelector(".echart-line-marker-chart-example");
		r &&
			((t = utils.getData(r, "options")),
			(r = window.echarts.init(r)),
			(e = [
	...
	echartsLineRaceChartInit = function () {
		var t,
			e,
			r = document.querySelector(".echart-line-race-chart-example");
		r &&
			((t = utils.getData(r, "options")),
			(r = window.echarts.init(r)),
			(e = [
	...
	echartsLineShareDatasetChartInit = function () {
		var t,
			e,
			r = document.querySelector(".echart-line-share-dataset-chart-example");
		r &&
			((t = utils.getData(r, "options")),
			(e = window.echarts.init(r)),
			echartSetOption(e, t, function () {
	...
	echartsUsaMapInit = function () {
		var t,
			e,
			r = document.querySelector(".echart-map-usa-example"),
			o = [
	...
	echartsNestedPiesChartInit = function () {
		var e,
			r,
			t,
			o,
			a,
			i = document.querySelector(".echarts-nested-pies-chart-example");
		i &&
			((e = utils.getData(i, "options")),
			(r = window.echarts.init(i)),
			(t = [
				{
					value: 412600,
					name: "Offline Marketing",
					itemStyle: { color: utils.getColor("primary") },
					label: { rich: { per: { color: "#1C4F93" } } },
				},
				{
					value: 641500,
					name: "Digital Marketing",
					itemStyle: { color: utils.rgbaColor(utils.getColor("info"), 0.35) },
					label: { rich: { per: { color: "#1978A2" } } },
				},
			]),
			(o = [
				{
					...
					itemStyle: { color: utils.rgbaColor(utils.getColor("primary"), 0.4) },
				},
				{
					value: 183e3,
					name: "Outrich Event",
					itemStyle: { color: utils.rgbaColor(utils.getColor("primary"), 0.6) },
				},
				{
					value: 138e3,
					name: "Ad Campaign",
					itemStyle: { color: utils.rgbaColor(utils.getColor("primary"), 0.8) },
				},
				{
					value: 183e3,
					name: "Social Media",
					itemStyle: { color: utils.rgbaColor(utils.getColor("info"), 0.2) },
				},
				{
					value: 45900,
					name: "Google Ads",
				...
				},
				{
					...
					itemStyle: { color: utils.rgbaColor(utils.getColor("info"), 0.5) },
				},
				{
					value: 183e3,
					name: "Email Marketing",
					itemStyle: { color: utils.rgbaColor(utils.getColor("info"), 0.7) },
				},
				{
					value: 91600,
					name: "Generate Backlinks",
					itemStyle: { color: utils.rgbaColor(utils.getColor("info"), 0.8) },
				},
			]),
			(a = function () {
				return {
					...
					series: [
						...
						},
						{
							...
							radius: ["70%", "75%"],
							barWidth: 10,
							labelLine: { length: 0, show: !1 },
							label: {
								formatter: "{per|{d}%}",
								rich: {
									per: { fontSize: 14, fontWeight: "bold", lineHeight: 33 },
								},
							},
							data: t,
						},
			...
			window.addEventListener("scroll", function t() {
				utils.isScrolledIntoView(i) &&
					(echartSetOption(r, e, a), window.removeEventListener("scroll", t));
			}));
	},
	...
	echartsPieEdgeAlignChartInit = function () {
		var t,
			e,
			r = document.querySelector(".echart-pie-edge-align-chart"),
			o = [
				{
					value: 800,
					name: "Starter",
	...
	echartsPieLabelAlignChartInit = function () {
		var t,
			e,
			r,
			o = document.querySelector(".echart-pie-label-align-chart");
		o &&
			((t = utils.getData(o, "options")),
	...
	echartsPieMultipleChartInit = function () {
		var t,
			e,
			r = document.querySelector(".echart-pie-multiple-chart");
		r &&
			((t = utils.getData(r, "options")),
			(e = window.echarts.init(r)),
			echartSetOption(e, t, function () {
	...
	echartsRadarCustomizedChartInit = function () {
		var t,
			e,
			r = document.querySelector(".echart-radar-customized-chart");
		function o(t) {
			var e = [
		...
		n &&
			...
			echartSetOption(e, t, function () {
				return {
					...
					xAxis: [
						_objectSpread({ gridIndex: 0, min: 0, max: 20 }, o()),
						_objectSpread({ gridIndex: 1, min: 0, max: 20 }, o()),
						_objectSpread({ gridIndex: 2, min: 0, max: 20 }, o()),
						_objectSpread({ gridIndex: 3, min: 0, max: 20 }, o()),
					],
					yAxis: [
	...
	echartsHorizontalStackedChartInit = function () {
		var t,
			e,
			r = document.querySelector(".echart-horizontal-stacked-chart-example");
		r &&
			((t = utils.getData(r, "options")),
			(r = window.echarts.init(r)),
			(e = [
	...
	echartsStackedLineChartInit = function () {
		var t,
			e,
			r = document.querySelector(".echart-stacked-line-chart-example");
		r &&
			((t = utils.getData(r, "options")),
			(r = window.echarts.init(r)),
			(e = [
	...
	echartsStackedVerticalChartInit = function () {
		var t,
			e,
			r,
			o,
			...
			i,
			l,
			s = document.querySelector(".echart-stacked-vertival-chart-example");
		s &&
			((t = utils.getData(s, "options")),
			(s = window.echarts.init(s)),
			(e = ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"]),
			(r = [20, 18, 15, 20, 12, 15, 10]),
			(o = [30, 20, 20, 25, 20, 15, 10]),
			(a = [35, 32, 40, 50, 30, 25, 15]),
			(i = [15, 25, 20, 18, 10, 15, 25]),
			(l = {
				itemStyle: {
					shadowColor: utils.rgbaColor(utils.getColor("dark"), 0.3),
				},
			}),
			echartSetOption(s, t, function () {
				return {
					color: [
						utils.getColor("primary"),
						utils.getColor("info"),
						"dark" === localStorage.getItem("theme") ? "#229BD2" : "#73D3FE",
						"dark" === localStorage.getItem("theme") ? "#195979" : "#A9E4FF",
					],
					tooltip: {
						trigger: "item",
						padding: [7, 10],
					...
					xAxis: {
						...
						splitLine: { show: !1 },
						splitArea: { show: !1 },
						axisLabel: { color: utils.getGrays()[600], margin: 8 },
						axisLine: {
							lineStyle: { color: utils.getGrays()[300], type: "dashed" },
						},
						axisTick: { show: !1 },
					...
					series: [
						{ name: "Urgent", type: "bar", stack: "one", emphasis: l, data: r },
						{ name: "High", type: "bar", stack: "one", emphasis: l, data: o },
						{ name: "Medium", type: "bar", stack: "one", emphasis: l, data: a },
						{
							name: "Low",
							type: "bar",
							stack: "one",
					...
					barWidth: "15px",
					grid: { top: "8%", bottom: 10, left: 0, right: 2, containLabel: !0 },
				};
			}));
	},
