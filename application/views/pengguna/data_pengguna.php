    ...
    <main class="main" id="top">
        <div class="container" data-layout="container">
            ...
            <div class="content">
                ...
                background-image: url(<?php echo base_url() ?>assets/img/icons/spot-illustrations/corner-4.png);
              "></div>
                    <!--/.bg-holder-->
                    ...
                    <div class="card-body position-relative">
                        <div class="row">
                            <div class="col-lg-8">
                                <h3>Data Pengguna</h3>
                                <p class="mb-0">
                                    Menu ini akan menampilkan data pengguna sistem
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="sticky-sidebar">
                            <div class="card sticky-top font-sans-serif">
                                <div class="card-header border-bottom">
                                    <h6 class="mb-0 fs-0">Data Pengguna</h6>
                                </div>
                                <div class="card-body">
                                    <ul class="mb-0 treeview" id="treeviewExample">
                                        <li class="treeview-list-item mb-3">
                                            <a data-bs-toggle="collapse" href="#jquery-Datatables" role="button" aria-expanded="false">
                                            ...
                                            <ul class="collapse treeview-list" id="jquery-Datatables" data-show="true">
                                                <li class="treeview-item">
                                                    <a class="flex-1" href="#jquery-datatables-default-example">
                                                        <p class="treeview-text fw-medium">
                                                            <span class="me-2 fas fa-hashtag fs--2"></span>Default example
                                                        </p>
                                                    </a>
                                                </li>
                                                <li class="treeview-item">
                                                    <a class="flex-1" href="#jquery-datatables-simple-pagination">
                                                        <p class="treeview-text fw-medium">
                                                            <span class="me-2 fas fa-hashtag fs--2"></span>Simple pagination
                                                        </p>
                                                    </a>
                                                </li>
                                                <li class="treeview-item">
                                                    <a class="flex-1" href="#jquery-datatables-number-pagination">
                                                        <p class="treeview-text fw-medium">
                                                            <span class="me-2 fas fa-hashtag fs--2"></span>Number pagination
                                                        </p>
                                                    </a>
                                                </li>
                                                <li class="treeview-item">
                                                    <a class="flex-1" href="#jquery-datatables-vertical-scroll">
                                                        <p class="treeview-text fw-medium">
                                                            <span class="me-2 fas fa-hashtag fs--2"></span>Vertical scroll
                                                        </p>
                                                    </a>
                                                </li>
                                                <li class="treeview-item">
                                                    <a class="flex-1" href="#jquery-datatables-fixed-columns">
                                                        <p class="treeview-text fw-medium">
                                                            <span class="me-2 fas fa-hashtag fs--2"></span>Fixed columns
                                                        </p>
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <li class="treeview-list-item">
                                            <a data-bs-toggle="collapse" href="#jquery-Select2" role="button" aria-expanded="false">
                                                <p class="treeview-text">Select2</p>
                                            </a>
                                            <ul class="collapse treeview-list" id="jquery-Select2" data-show="true">
                                                <li class="treeview-item">
                                                    <a class="flex-1" href="#jquery-select2-single-select">
                                                        <p class="treeview-text fw-medium">
                                                            <span class="me-2 fas fa-hashtag fs--2"></span>SIngle Select
                                                        </p>
                                                    </a>
                                                </li>
                                                <li class="treeview-item">
                                                    <a class="flex-1" href="#jquery-select2-multiple-select">
                                                        <p class="treeview-text fw-medium">
                                                            <span class="me-2 fas fa-hashtag fs--2"></span>Multiple select
                                                        </p>
                                                    </a>
                                                </li>
                                            </ul>
                    ...
                    <div class="col-lg-8 col-xxl-9">
                        <div class="card mb-3">
                            ...
                            <div class="card-body position-relative">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h3 class="fs-2">Notice</h3>
                                        <p class="mb-0">
                                            Disini akan ditampilkan pengumuman, catatan, atau info tertentu dari administrator atau pihak yang tertentu
                                        </p>
                                        <a class="btn btn-link btn-sm ps-0 mt-2" href="https://datatables.net/" target="_blank">Info lebih lanjut<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card mb-3">
                            <div class="card-header">
                                <div class="row flex-between-end">
                                    <div class="col-auto align-self-center">
                                        <h5 class="mb-0" data-anchor="data-anchor">Tabel Data Pengguna</h5>
                                    </div>
                                    <div class="col-auto ms-auto">
                                        <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                                            <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-19daa8ef-c0f1-4548-bd3a-32bca1348c21" type="button" role="tab" aria-controls="dom-19daa8ef-c0f1-4548-bd3a-32bca1348c21" aria-selected="true" id="tab-dom-19daa8ef-c0f1-4548-bd3a-32bca1348c21">Preview</button>
                                            <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-63d68ffd-bea6-46d8-a3f3-91859568c018" type="button" role="tab" aria-controls="dom-63d68ffd-bea6-46d8-a3f3-91859568c018" aria-selected="false" id="tab-dom-63d68ffd-bea6-46d8-a3f3-91859568c018">Code</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body pt-0">
                                <div class="tab-content">
                                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-19daa8ef-c0f1-4548-bd3a-32bca1348c21" id="dom-19daa8ef-c0f1-4548-bd3a-32bca1348c21">
                                        <div class="d-flex align-items-center justify-content-end my-3">
                                            <div id="bulk-select-replace-element">
                                                <button class="btn btn-info btn-sm" type="button" onclick="sinkronisasi()"><span class="fas fa-sync" data-fa-transform="shrink-3 down-2"></span><span class="ms-1">Sinkronisasi Data User</span></button>
                                                <button target="_blank" class="btn btn-dark btn-sm" type="button" onclick="cetak()"><span class="fas fa-file-pdf" data-fa-transform="shrink-3 down-2"></span><span class="ms-1">Cetak Data User</span></button>
                                            </div>
                                        </div>
                                        <div>
                                            <table class="table table-bordered table-striped fs--1 mb-0" id="tabel_pengguna">
                                                <thead class="bg-200 text-900">
                                                    <tr>
                                                        <th class="sort" data-sort="nip">No</th>
                                                        <th class="sort" data-sort="nama">Nama</th>
                                                        <th class="sort" data-sort="jabatan">Jenis</th>
                                                        <th>Aksi</th>
                                                    </tr>
                                                </thead>
                                            </table>
                                    ...
                                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-63d68ffd-bea6-46d8-a3f3-91859568c018" id="dom-63d68ffd-bea6-46d8-a3f3-91859568c018">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function sinkronisasi() {
            return new Promise((resolve, reject) => {
                ...
                $.ajax({
                    url: '<?php echo base_url() ?>update_data_user',
                    type: 'POST',
                    dataType: 'JSON',
        ...
        function cetak() {
            window.open('<?php echo base_url() ?>print_data_user', '_blank');
        }
    </script>
