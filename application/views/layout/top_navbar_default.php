<nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
            ...
            <div class="search-box" data-list='{"valueNames":["title"]}'>
                ...
                <div class="dropdown-menu border font-base start-0 mt-2 py-0 overflow-hidden w-100">
                    <div class="scrollbar list py-3" style="max-height: 24rem;">
                        <h6 class="dropdown-header fw-medium text-uppercase px-x1 fs--2 pt-0 pb-2">Recently Browsed</h6><a class="dropdown-item fs--1 px-x1 py-1 hover-primary" href="<?php echo base_url() ?>app/events/event-detail.html">
                        ...
                        <a class="dropdown-item fs--1 px-x1 py-1 hover-primary" href="<?php echo base_url() ?>app/e-commerce/customers.html">
                            <div class="d-flex align-items-center">
                                <span class="fas fa-circle me-2 text-300 fs--2"></span>
                        ...
                        <h6 class="dropdown-header fw-medium text-uppercase px-x1 fs--2 pt-0 pb-2">Suggested Filter</h6><a class="dropdown-item px-x1 py-1 fs-0" href="<?php echo base_url() ?>app/e-commerce/customers.html">
                            <div class="d-flex align-items-center"><span class="badge fw-medium text-decoration-none me-2 badge-subtle-warning">customers:</span>
                                <div class="flex-1 fs--1 title">All customers list</div>
                            </div>
                        </a>
                        <a class="dropdown-item px-x1 py-1 fs-0" href="<?php echo base_url() ?>app/events/event-detail.html">
                            <div class="d-flex align-items-center"><span class="badge fw-medium text-decoration-none me-2 badge-subtle-success">events:</span>
                                <div class="flex-1 fs--1 title">Latest events in current month</div>
                            </div>
                        </a>
                        <a class="dropdown-item px-x1 py-1 fs-0" href="<?php echo base_url() ?>app/e-commerce/product/product-grid.html">
                        ...
                        <hr class="text-200 dark__text-900" />
                        <h6 class="dropdown-header fw-medium text-uppercase px-x1 fs--2 pt-0 pb-2">Members</h6><a class="dropdown-item px-x1 py-2" href="<?php echo base_url() ?>pages/user/profile.html">
                            <div class="d-flex align-items-center">
                        ...
                        <a class="dropdown-item px-x1 py-2" href="<?php echo base_url() ?>pages/user/profile.html">
                            <div class="d-flex align-items-center">
    ...
    <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
        ...
        <li class="nav-item d-none d-sm-block">
            <a class="nav-link px-0 notification-indicator notification-indicator-warning notification-indicator-fill fa-icon-wait" href="<?php echo base_url() ?>app/e-commerce/shopping-cart.html"><span class="fas fa-shopping-cart" data-fa-transform="shrink-7" style="font-size: 33px;"></span><span class="notification-indicator-number">1</span></a>
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end dropdown-menu-card dropdown-menu-notification dropdown-caret-bg" aria-labelledby="navbarDropdownNotification">
                <div class="card card-notification shadow-none">
                    ...
                    <div class="card-footer text-center border-top"><a class="card-link d-block" href="<?php echo base_url() ?>app/social/notifications.html">View all</a></div>
                </div>
            </div>
                    ...
                    <div class="scrollbar-overlay nine-dots-dropdown">
                        <div class="card-body px-3">
                            <div class="row text-center gx-0 gy-0">
                                <div class="col-4"><a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none" href="<?php echo base_url() ?>pages/user/profile.html" target="_blank">
                                ...
                                <div class="col-4"><a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none" href="<?php echo base_url() ?>app/events/event-detail.html" target="_blank">
        ...
        <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
                <div class="bg-white dark__bg-1000 rounded-2 py-2">
                    ...
                    <a class="dropdown-item" href="<?php echo base_url() ?>pages/authentication/card/logout.html">Logout</a>
                </div>
            </div>
        </li>
    </ul>
